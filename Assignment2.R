birthdays = read.csv('Desktop/Applied Analytics/App Anlytics Framework 1/Assignments/president_birthdays.csv')
heights = read.csv('Desktop/Applied Analytics/App Anlytics Framework 1/Assignments/president_heights.csv')
states = read.csv('Desktop/Applied Analytics/App Anlytics Framework 1/Assignments/president_states.csv')
library(lubridate); 
